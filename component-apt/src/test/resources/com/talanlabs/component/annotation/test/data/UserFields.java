...
public final class UserFields {
	...
	private UserFields() { super(); }

	public static final String CLASS_NAME = "com.talanlabs.component.annotation.test.data.IUser";
	...
	private static IDotField<com.talanlabs.component.annotation.test.data.AddressFields.SubFields> address_ = null;
	public static synchronized IDotField<com.talanlabs.component.annotation.test.data.AddressFields.SubFields> address() { if (address_ == null) { address_ = new DefaultDotField<com.talanlabs.component.annotation.test.data.AddressFields.SubFields>(new com.talanlabs.component.annotation.test.data.AddressFields.SubFields(address),address); } return address_; }
	...
	private static IField fullname_ = null;
	public static synchronized IField fullname() { if (fullname_ == null) { fullname_ = new DefaultField(fullname); } return fullname_; }
	...
	public static final class SubFields {
		...
		private IDotField<com.talanlabs.component.annotation.test.data.AddressFields.SubFields> address_ = null;
		public synchronized IDotField<com.talanlabs.component.annotation.test.data.AddressFields.SubFields> address() { if (address_ == null) { address_ = new DefaultDotField<com.talanlabs.component.annotation.test.data.AddressFields.SubFields>(new com.talanlabs.component.annotation.test.data.AddressFields.SubFields(ComponentHelper.PropertyDotBuilder.build(parentName,address)),ComponentHelper.PropertyDotBuilder.build(parentName,address)); } return address_; }
		...
		private IField fullname_ = null;
		public synchronized IField fullname() { if (fullname_ == null) { fullname_ = new DefaultField(ComponentHelper.PropertyDotBuilder.build(parentName,fullname)); } return fullname_; }
