...
public final class AddressDtoFields {

	private AddressDtoFields() { super(); }

	public static final String CLASS_NAME = "com.talanlabs.component.annotation.test.data.IAddressDto";
